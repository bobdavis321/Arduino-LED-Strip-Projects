...
// by: BOB Davis  
// Shifted to Ports B and D to allow serial communications
...
int maxled=180;
String text="080ARDUINO LED STRIP PROJECTS    ";
...
void loop() {
//  Serial.readBytesUntil(stopc, text, 30);
  if (Serial.available() > 0) text=Serial.readString();
  Serial.print(text);
  ...
  for (int l=3; l<33; l++){     // 30 is number of characters to send
