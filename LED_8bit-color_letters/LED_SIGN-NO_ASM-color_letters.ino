...
char text2[]="WS2812 STRIP   EXTENDED DATA                       ";
...
// COLOR TEST
  ...
  for (int l=0; l<30; l++){     // 30 is number of characters to send
    switch (l){                 // case is faster than if's
      case 1: red=0; green=14; blue=0; break; 
      case 2: red=0; green=0; blue=14; break; 
      case 3: red=14; green=14; blue=0; break; 
      case 4: red=0; green=14; blue=14; break; 
      case 5: red=14; green=0; blue=14; break; 
      case 6: red=14; green=14; blue=14; break; 
    }
    for (int r=0; r<6; r++){    // number of rows per character
      sendPixelRow(0xFF);       // Light All
    }
  }
  sei();
  delay(4000);                  // Wait to display results
  
  red=24;   green=0;  blue=0;
  cli();                        // No time for interruptions!
  for (int l=0; l<30; l++){     // 30 is number of characters to send
    switch (l){                 // case is faster than if's
      case 1: red=0; green=24; blue=0; break; 
      case 2: red=0; green=0; blue=24; break; 
      case 3: red=24; green=24; blue=24; break; 
      case 4: red=24; green=0; blue=0; break; 
      case 5: red=0; green=24; blue=0; break; 
      case 6: red=0; green=0; blue=24; break; 
    }
    // Using a loop os too slow with the character lookups.
  ...
  cli();                        // No time for interruptions!
  for (int l=0; l<30; l++){     // 30 is number of characters to clear
    for (int r=0; r<6; r++){    // 6 is the number of rows per character
...
// FIREWORKS
  ...
  for (int cycle=0; cycle<100; cycle++){
    ...
    int rano=random(180);        // Set Random location
    for (int l=0; l<180; l++){   // 180 is number of bytes to send
      if (l==rano) sendPixelRow(sbit); 
      else       sendPixelRow(0x00);  
    } 
    delay(20); 
  }
  sei();
